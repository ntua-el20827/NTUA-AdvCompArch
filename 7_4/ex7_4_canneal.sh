...
echo "[CANNEAL] Best configuration: ${tests[$best_config_index]} with IPC $max_ipc" >> /home/george/Workshop/uni/8sem/archlab/ex1/ex7_4/best_configurations4.txt

echo "[RESULT] Configuration with the highest IPC for CANNEAL is $max_ipc_config with IPC $max_ipc"

...
output_folder_path = "/home/george/Workshop/uni/8sem/archlab/ex1/ex7_5/output_files"
...
plt.plot(range(1, 6), geometric_means, marker='o', color='blue')
...
for cpu_type, ipc_values in cpu_ipc_values.items():
    ...
    plt.plot(range(1, 6), ipc_values, label=cpu_type)

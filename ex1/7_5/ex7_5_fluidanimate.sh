...
echo "[FLUIDANIMATE] Best configuration: ${tests[$best_config_index]} with IPC $max_ipc" >> /home/george/Workshop/uni/8sem/archlab/ex1/ex7_5/best_configurations5.txt
